...
### T98. [🟢 착수 가능 — 제작자 물 페인팅 완료·커밋(`7a702a3`, 2026-08-03) | 🔴 선행 버그 1건 = 제작자 Maker 수정 필요 | 🧭 범위 결정 대기] 고정 수역 실배치 — 맵에 물을 실제로 놓는다
...
### T102. [✅ 완료 — 2026-08-01 지휘자 직접 | ui_lint 0 error / 89 warning · 엔티티 341 유지 · UUID·자식·트랜스폼 보존 | 런타임 검증 보류(제작자 수행)] `FurnacePopup` 프리팹 타입 교체 — 규칙 11 4차 사고의 근본 원인 제거 (⚖️ 2026-08-01 제작자 관찰)
