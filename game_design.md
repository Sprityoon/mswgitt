...
- [x] **19-D 마을 생활 소품** (T75 — **코드 완료 · 조건부 통과 2026-08-04** | refresh Error=0 / **Warning 48(신규 baseline)** | Play 보류): 소품 P1~P11 · 11모델/43인스턴스 · Trigger+YSort 전부 · Occ=울타리·술통·궤짝·수레만. Warning +31(`LWA-4012`) 청소는 **T103**(Play와 분리).
